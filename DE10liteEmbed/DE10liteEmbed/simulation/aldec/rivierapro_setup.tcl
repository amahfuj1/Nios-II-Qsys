...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Embed_onchip_memory2_0.v"                                           -work onchip_memory2_0                   
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Embed_jtag_uart_0.v"                                                -work jtag_uart_0                        
